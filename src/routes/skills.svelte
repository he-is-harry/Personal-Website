<script lang="ts">
    ...
    onMount(() => {
        ...
        // Assume left and right padding of 28px, which makes
        // this less accurate on phone but not by much
        // Take max width before next threshold, subtract 56px,
        // and make the height 9:16.
        // (W - 56) * 9 / 16
        // Right before 240 px
        playerWidth = "100%";
        playerHeight = "103.75px";
        if(getWidth() < 360) {
            // Right before 360 px
            playerHeight = "171px";
        } else if(getWidth() < 480) {
            // Right before 480 px
            playerHeight = "238.5px";
        } else if(getWidth() < 768) {
            // Right before 768 px
            playerHeight = "400.5px";
        } else if(getWidth() < 1024) {
            // Right before 1024 px
            playerHeight = "544.5px";
        } else if(getWidth() < 1240) {
            // Right before 1240 px
            // Now the grid is halved after reaching the 1024 
            // threshold so the width must be halved before adjusting 
            // to 9:16
            playerHeight = "333px";
        } else if(getWidth() < 1440) {
            // Right before 1440 px
            playerHeight = "389.25px";
        } else if(getWidth() < 1696) {
            // Right before 1696 px
            // Now since passed the 1696 threshold, total padding
            // is now 128 px
            playerHeight = "441px";
        } else if(getWidth() < 1920) {
            // Right before 1920 px
            playerHeight = "504px";
        }
...
<section id="Skills">
    ...
    <div class="expanded-skills-block">
        ...
        <div class="complete-skill-descriptions">
            ...
            <div class="communication-skill">
                ...
                <p class="skill-description">With over 400+ hours of experience conversing at Kumon and Markville’s Computer Science Club, Harry can articulate himself with speech, handwritten and electronic presentations, and videos.</p>
            </div>
    ...
    <!-- Do grid with 100% width but set height with media queries, max beyond threshold is 16 by 9-->
    <div class="teaching-container">
        <div class="teaching-description">
            <div class="teaching-header-container">
                <div class="large-icon-wrapper">
                    <svg version="1.0" xmlns="http://www.w3.org/2000/svg"
                    width="50" height="42" viewBox="0 0 1280.000000 1090.000000"
                    preserveAspectRatio="xMidYMid meet">
                    <g transform="translate(0.000000,1090.000000) scale(0.100000,-0.100000)"
                    fill="#000000" stroke="none">
                    <path stroke="black" stroke-width="30px" d="M6335 10893 c-81 -7 -252 -35 -323 -53 -69 -17 -78 -17 -165 -2 -71
                ...
                <h1 class="teaching-header">Teaching Skill</h1>
            </div>
...
<style>
    ...
    /* Teaching Skills Block */
    .teaching-container {
        grid-template-columns: repeat(1, minmax(0, 1fr));
        grid-auto-columns: max-content;
        display: grid;
        padding-inline: var(--size-6);
        width: calc(100% - 2 * var(--size-6));
    ...
    @media (min-width: 1440px) {
        .teaching-container {
            padding-inline: var(--size-9);
            width: calc(100% - 2 * var(--size-9));
        }
    }

    .teaching-header-container {
        display: flex;
        margin: 0;
    }
